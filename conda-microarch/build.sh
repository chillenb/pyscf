...
export CMAKE_CONFIGURE_ARGS="-DWITH_F12=OFF -DENABLE_SMD=ON -DBLA_VENDOR=Intel10_64lp_seq -DUSE_QCINT=ON"

# env PYTHON not defined in certain conda-build version
# $PYTHON -m pip install . -vv
VERBOSE=1 CMAKE_BUILD_PARALLEL_LEVEL="${CPU_COUNT}" pip install -v --prefix=$PREFIX .
